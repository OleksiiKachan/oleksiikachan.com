        ...
        return (
            <div className={classNames('generalInformationHeader', this.props.className)}>
                ...
                <div className={classNames('generalInformationHeader_side')}>
                    <div className={classNames('generalInformationHeader__placeHolder')}></div>
                    <div className={classNames('generalInformationHeader__head')}>
                        <h1 className={classNames('generalInformationHeader__name')}>{this.props.generalInformation.name}</h1>
                        <h2 className={classNames('generalInformationHeader__position')}>{this.props.generalInformation.title}</h2>
                    </div>
                    <SocialMediaButtonPanel resources={this.props.generalInformation.resources} className={classNames('generalInformationHeader__socialMedia')}/>
                </div>
            </div>
        );
    }
